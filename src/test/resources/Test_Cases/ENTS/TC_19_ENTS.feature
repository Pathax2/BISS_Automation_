Feature: TC_19_ENTS - Transfer Application E2E (Individual to Agent) and submits appeals
  ...
  Scenario: AT-ENTS-TRANSFERS-E2E-19 - Individual completes all transfer types to Agent and submits appeals
