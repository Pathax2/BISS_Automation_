...
//                       iHerdSearchField, iActiveStatusCheckbox, iAdminCheckText
//                     Copy them from the Selenium repository (tools/copy-from-selenium.ps1 -WithRepository) or add them,
//                     otherwise ObjReader throws "Locator not found in Object Repository" when the step runs.
//
// Author        : Aniket Pathare | aniket.pathare@government.ie
// Date Created  : 26-03-2026
// Updated       : 18-09-2026 - Migrated to Playwright (Selenium import removed, header notes, step logging)
// ===================================================================================================================================
...
public class TC_07
{
    ...
    {
        log.info("[STEP] And the agent applies the '" + pFilter + "' quick filter");
    ...
    {
        log.info("[STEP] And the agent picks a herd from the list");

        iAction("CLICK", "XPATH", "(//mat-row | //tbody/tr)[1]", null);
    }
    ...
    {
        log.info("[STEP] When the agent selects the herd from row " + pRow);
        ...
        log.info("Herd selected from row " + pRow + " : " + iHerd.trim());
    }
    ...
    {
        log.info("[STEP] And the active status checkbox is present on the Active Farmer screen");
    ...
    {
        log.info("[STEP] And the admin check message is visible on the Active Farmer screen");
