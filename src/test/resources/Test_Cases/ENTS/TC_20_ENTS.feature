Feature: TC_20_ENTS - Transfer Application E2E (ETF Partner to Agent) and then submits appeals
  ...
  Scenario: AT-ENTS-TRANSFERS-E2E-20 - ETF Partner completes all transfer types to Agent and then submits appeals
