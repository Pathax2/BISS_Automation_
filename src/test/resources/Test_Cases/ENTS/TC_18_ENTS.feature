Feature: TC_18_ENTS - Transfer Application End-to-End Regression Pack (Same Agent)
  ...
  Scenario: AT-ENTS-TRANSFERS-E2E - Agent completes all transfer types within the same agent and submits appeals
